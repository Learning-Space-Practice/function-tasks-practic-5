...
let res4;
res4 = ar3.filter( item => typeof item === 'number')
...
const ar7 = [50, 70, 100, 20, 30, 60];
let res7;
 let callBack7 = (currentValue) => currentValue > 10;
...
let res8;
res8 = ar7.every((currentValue) => currentValue < 70);// сюда в скобки дописываете стрелочную функцию
